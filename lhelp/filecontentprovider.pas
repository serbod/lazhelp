...
type
  ...
  public
    ...
    class function GetProperContentProviderClass(const AURL: String): TBaseContentProviderClass; override;
...
class function TFileContentProvider.GetProperContentProviderClass(const AURL: String
