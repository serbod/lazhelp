...
type
  ...
  TChmTopicItemList = class(TList)
  private
    function GetItem(AIndex: Integer): TChmTopicItem;
    procedure SetItem(AIndex: Integer; AValue: TChmTopicItem);
  protected
    procedure Notify(Ptr: Pointer; Action: TListNotification); override;
  public
    function AddItem(const ATitle, ALocalUrl: string): TChmTopicItem;
    property Items[AIndex: Integer]: TChmTopicItem read GetItem write SetItem; default;
  end;
...
function TChmTopicItemList.GetItem(AIndex: Integer): TChmTopicItem;
begin
  Result := TChmTopicItem(Get(AIndex));
end;

procedure TChmTopicItemList.SetItem(AIndex: Integer; AValue: TChmTopicItem);
begin
  Put(AIndex, AValue);
end;

procedure TChmTopicItemList.Notify(Ptr: Pointer; Action: TListNotification);
begin
  inherited Notify(Ptr, Action);
  if Action = lnDeleted then
  begin
    TChmTopicItem(Ptr).Free();
  end;
end;
